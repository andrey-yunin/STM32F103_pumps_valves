...
/*
 * Timeout parameter for Fluidics commands is uint32 little-endian in payload
 * bytes 3..6. timeout=0 means default safety timeout for START/OPEN and is
 * invalid for RUN_DURATION.
 */
