...
typedef enum {
	...
	CMD_SET_PUMP_STATE      = 0x10, // Установить состояние насоса (вкл/выкл) // << ЭТИ ДВЕ КОМАНДЫ ДОЛЖНЫ БЫТЬ
	CMD_SET_VALVE_STATE     = 0x11, // Установить состояние клапана (откр/закр) // << ЭТИ ДВЕ КОМАНДЫ ДОЛЖНЫ БЫТЬ
    } CommandID_t;
